 ...
 */
final class Version20240416122130 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE grades (id INT NOT NULL, route_id INT NOT NULL, username VARCHAR(255) NOT NULL, grade INT NOT NULL, PRIMARY KEY(id))');
